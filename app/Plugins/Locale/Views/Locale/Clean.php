<fieldset class="fieldset white">
	...
	{
		?>
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=Locale&amp;action=Clean" method="post" class="form">
...
<fieldset class="fieldset white">
	...
	if (isset($tpl['field_arr']) && !empty($tpl['field_arr']))
	{
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=Locale&amp;action=Clean" method="post" class="form">
			...
			<table cellpadding="0" cellspacing="0" class="table b10" style="width: 100%">
				<thead>
					<tr>
				...
				foreach ($tpl['field_arr'] as $field)
				{
					...
					?>
					<tr class="<?php echo !$skip ? 'table-row-odd' : 'table-row-even'; ?>">
