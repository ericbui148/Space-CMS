...
<br /><br />Please, note that it is against our license policy to install our products without providing valid license key. You can check our our License policy <a href="licence.html" target="_blank">here</a>.</p>
	...
	<form action="index.php?controller=Installer&amp;action=Step6&amp;install=1" method="post" id="frmStep5" class="i-form">
				...
				<tr>
					<td>
						<p>
							...
							<input type="text" tabindex="1" name="license_key" class="form-field w300 required" value="<?php echo isset($STORAGE['license_key']) ? htmlspecialchars($STORAGE['license_key']) : NULL; ?>" />
						</p>
					</td>
				</tr>
			</tbody>
		...
		<div class="t20">
			...
			<input type="submit" tabindex="2" value="Continue &raquo;" class="button float_right l5" />
			<input type="button" tabindex="3" value="&laquo; Back" class="button float_right" onclick="window.location='index.php?controller=Installer&amp;action=Step4'" />
			<br class="clear_both" />
		</div>
	</form>
</div>