...
if (isset($tpl['status']))
{
	...
	{
		case 2:
			UtilComponent::printNotice('Login required', 'In order to access this page you need to log in first.', false, false);
			break;
	}
} else {
	?>
	<div class="i-wrap">
		...
		<?php
		UtilComponent::printNotice('Database Update', 'You can update either to specified database version or more than just one.', true, false);
		?>
		
		<div id="grid"></div>
		
		<button type="button" class="button btn-execute-all t10" style="display: none">Execute</button>
