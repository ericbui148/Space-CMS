...
if (fdApp !== undefined) {
	fdApp = jQuery_1_8_2.extend(fdApp, {
		locale: {
			button: <?php echo AppController::jsonEncode(array_merge(__('buttons', true), array('add' =>__('btnAdd', true, false), 'edit' =>__('btnEdit', true, false), 'create_element' =>__('btnMenuItemCreate', true, false),'cancel' =>__('btnCancel', true, false)))); ?>
		}
	});
}