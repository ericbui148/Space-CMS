...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminSliders&amp;action=Index"><?php __('menuSliders'); ?></a></li>
			<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminSliders&amp;action=Create"><?php __('sliderAdd'); ?></a></li>
		</ul>
	</div>
	<?php
	UtilComponent::printNotice(@$titles['SLI01'], @$bodies['SLI01']);
	?>
	<div class="b10">
	...
	var Grid = Grid || {};
	var myLabel = myLabel || {};
	myLabel.name = "<?php __('lblSliderName', false, true); ?>";
	myLabel.type = "<?php __('lblSliderType', false, true); ?>";
	myLabel.status = "<?php __('lblSliderStatus', false, true); ?>";
