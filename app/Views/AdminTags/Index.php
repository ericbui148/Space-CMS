...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminTags&amp;action=Index">Danh sách Tag</a></li>
			<li class="ui-state-default ui-corner-top ui-tabs-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminTags&amp;action=Create">Thêm mới</a></li>
		</ul>
	</div>
	<?php
	UtilComponent::printNotice('Danh sách tag', 'Dưới đây là danh sách tất cả tag, click hình bút chì để sửa 1 tag');
	?>
	<div class="b10">
	...
	var Grid = Grid || {};
	var myLabel = myLabel || {};
	myLabel.name = "<?php __('lblContactName', false, true); ?>";
