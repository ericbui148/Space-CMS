...
<p>
	...
	<span class="block">
		<input name="error_email" class="form-field" value="<?php echo $tpl['field_arr']['error_email'] != '' ? SanitizeComponent::clean($tpl['field_arr']['error_email']) : null; ?>"/>
	</span>
</p>
<p>
...
<p>
	...
	<span class="block">
		<select name="send_confirmation" class="form-field w150 field-required">
			<?php
			foreach(__('_yesno', true, false) as $k => $v)
			{
				?>
