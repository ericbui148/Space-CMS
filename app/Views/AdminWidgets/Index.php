...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminWidgets&amp;action=Index">Danh sách widget</a></li>
			<li class="ui-state-default ui-corner-top ui-tabs-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminWidgets&amp;action=Create">Thêm widget</a></li>
		</ul>
	</div>
	<?php
	UtilComponent::printNotice(@$titles['WIDGET01'], @$bodies['WIDGET01']);
	?>
	<div class="b10">
	...
	var Grid = Grid || {};
	var myLabel = myLabel || {};
	myLabel.name = "<?php __('lblWidgetName', false, true); ?>";
	myLabel.created = "<?php __('lblWidgetCreated'); ?>";
	myLabel.modified = "<?php __('lblWidgetModified'); ?>";
	myLabel.status = "<?php __('lblWidgetStatus', false, true); ?>";
