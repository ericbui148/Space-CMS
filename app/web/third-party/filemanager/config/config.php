...
include ROOT_PATH.'app/Config/options.inc.php';
$upload_dir = INSTALL_FOLDER . UPLOAD_PATH; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../' . UPLOAD_PATH; // relative path from filemanager folder to upload folder (with final /)
// thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../' . UPLOAD_PATH; // relative path from filemanager folder to thumbs folder (with final /)
